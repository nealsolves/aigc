SCENARIOS: dict[str, dict] = {
    ...
    "medium_risk_medical": {
        ...
        "output": {"result": "Common side effects include nausea, dizziness, and stomach upset. Consult your physician."},
    ...
    "high_risk_drug_interaction": {
        ...
        "output": {"result": "Concurrent use significantly increases bleeding risk. Contraindicated without oversight."},
    ...
    "chain_entry_2": {
        ...
        "output": {"result": "Metformin may interact with contrast dyes. Hold 48 h before and after imaging."},
        "context": {"domain": "medical", "human_review_required": True, "role_declared": True, "schema_exists": True},
        "policy": "medical_ai.yaml",
        "model_provider": "mock",
        "model_id": "mock-model",
