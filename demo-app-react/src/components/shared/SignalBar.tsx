...
export default function SignalBar({ name, contribution, color }: Props) {
  ...
  return (
    <div className="flex items-center gap-2 mb-1.5">
      <span className="font-mono text-[9px] flex-1" style={{ color: 'var(--text-secondary)' }}>
        {name}
      </span>
      <div
      ...
      <span className="font-mono text-[9px] w-8 text-right" style={{ color: 'var(--text-secondary)' }}>
