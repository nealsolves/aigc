...
- `python -m build --sdist --wheel --outdir /tmp/aigc-build-rerun`
- `python -m build --sdist --wheel --outdir /tmp/aigc-build-rerun --no-isolation`

### Environment notes
- Date: 2026-03-16
- Platform: Darwin, Python 3.12.9
- Branch: `docs/milestone1-parity-fixes`
- Working tree during audit: **dirty** (multiple modified docs and untracked files)
